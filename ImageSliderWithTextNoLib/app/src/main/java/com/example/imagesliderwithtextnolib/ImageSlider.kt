package com.example.imagesliderwithtextnolib
...
class ImageSlider @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    init {
        ...
        placeholder = typedArray.getResourceId(R.styleable.ImageSlider_placeholder, R.drawable.slider_placeholder)
        errorImage = typedArray.getResourceId(R.styleable.ImageSlider_error_image, R.drawable.slider_error)
    ...
    fun setImageList(imageList: List<SlideModel>, centerCrop: Boolean = false) {
        viewPagerAdapter = ViewPagerAdapter(context, imageList, 0, errorImage, placeholder, centerCrop)
