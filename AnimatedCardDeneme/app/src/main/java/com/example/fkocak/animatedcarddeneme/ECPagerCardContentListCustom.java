 ...
 */
public class ECPagerCardContentListCustom extends ListView {

    private boolean scrollDisabled;
    private int mPosition;

    private ECCardContentListItemAdapterCustom contentListItemAdapter;

    private ECPagerCardHeadCustom headView;

    public ECPagerCardContentListCustom(Context context) {
        super(context);
        init(context);
    }

    public ECPagerCardContentListCustom(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ECPagerCardContentListCustom(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public void init(Context context) {
        headView = new ECPagerCardHeadCustom(context);
...
//        this.setOverScrollMode(OVER_SCROLL_NEVER);
    ...
    public ECCardContentListItemAdapterCustom getContentListItemAdapter() {
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        if (adapter instanceof ECCardContentListItemAdapterCustom) {
            this.contentListItemAdapter = (ECCardContentListItemAdapterCustom) adapter;
        }
    }
    ...
    protected ECPagerCardHeadCustom getHeadView() {
        return headView;
    }
