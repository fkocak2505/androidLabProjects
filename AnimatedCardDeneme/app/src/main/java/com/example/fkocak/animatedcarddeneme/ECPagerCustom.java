...
public class ECPagerCustom extends ViewPager {
    private int currentPosition;
    private boolean pagingDisabled;

    public ECPagerCustom(Context context) {
        super(context);
        init();
    }

    public ECPagerCustom(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
...
//        this.setOverScrollMode(OVER_SCROLL_NEVER);
    ...
    public ECCardDataCustom getDataFromAdapterDataset(int position) {
        return ((ECPagerViewAdapterCustom) this.getAdapter()).getDataset().get(position);
    }
    ...
    public boolean expand() {
        ECPagerViewAdapterCustom adapter = (ECPagerViewAdapterCustom) getAdapter();
