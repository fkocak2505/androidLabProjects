...
public class MainActivity extends Activity {
    ...
    private ECPagerViewCustom ecPagerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ECPagerViewAdapterCustom adapter = new ECPagerViewAdapterCustom(this, new ExampleDataset().getDataset()) {
            @Override
            public void instantiateCard(LayoutInflater inflaterService, ViewGroup head, ListView list, final ECCardDataCustom data) {
        ...
        ecPagerView = (ECPagerViewCustom) findViewById(R.id.ec_pager_element);

        ecPagerView.setPagerViewAdapter(adapter);
        ecPagerView.setBackgroundSwitcherView((ECBackgroundSwitcherViewCustom) findViewById(R.id.ec_bg_switcher_element));

        final ItemsCountView itemsCountView = (ItemsCountView) findViewById(R.id.items_count_view);
        ecPagerView.setOnCardSelectedListener(new ECPagerViewCustom.OnCardSelectedListener() {
            @Override
