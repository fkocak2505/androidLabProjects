 ...
 */
public class ECPagerCardCustom extends FrameLayout {

    private ECPagerCardContentListCustom ecPagerCardContentList;
    private boolean animationInProgress;
    private boolean cardExpanded;

    public ECPagerCardCustom(Context context) {
        super(context);
    }

    public ECPagerCardCustom(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ECPagerCardCustom(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate() {
        ...
        try {
            ecPagerCardContentList = (ECPagerCardContentListCustom) getChildAt(0);
//            ecPagerCardListContent.disableScroll();
    ...
    public boolean expand() {
        ...
        final ECPagerCustom pager = (ECPagerCustom) getParent();
        final ECPagerViewCustom pagerView = (ECPagerViewCustom) pager.getParent();
...
//        ecPagerCardListContent.disableScroll();
    ...
    public ECPagerCardContentListCustom getEcPagerCardContentList() {
