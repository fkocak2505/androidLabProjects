...
public class BackgroundBitmapCacheCustom {
    private LruCache<Integer, Bitmap> mBackgroundsCache;

    private static BackgroundBitmapCacheCustom instance;

    public static BackgroundBitmapCacheCustom getInstance() {
        if (instance == null) {
            instance = new BackgroundBitmapCacheCustom();
            instance.init();
        }
        return instance;
    }
