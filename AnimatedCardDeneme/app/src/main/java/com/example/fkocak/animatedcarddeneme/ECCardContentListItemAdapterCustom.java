 ...
 */
public abstract class ECCardContentListItemAdapterCustom<T> extends ArrayAdapter<T> {
    private boolean zeroItemsMode = true;

    public ECCardContentListItemAdapterCustom(@NonNull Context context, @LayoutRes int resource, @NonNull List<T> objects) {
