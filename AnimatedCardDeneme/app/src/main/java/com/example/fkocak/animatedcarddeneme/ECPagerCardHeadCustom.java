 ...
 */
public class ECPagerCardHeadCustom extends FrameLayout {

    private ImageView headBackgroundImageView;

    public ECPagerCardHeadCustom(Context context) {
        super(context);
        init(context);
    }

    public ECPagerCardHeadCustom(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ECPagerCardHeadCustom(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void animateHeight(int targetHeight, int duration, int delay) {
        ...
        cardHeadHeightAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                ECPagerCardHeadCustom.this.setLayoutParams(cardHeaderLayoutParams);
            }
        });
