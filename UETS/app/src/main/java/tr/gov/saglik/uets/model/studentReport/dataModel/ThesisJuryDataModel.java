...
public class ThesisJuryDataModel {
    ...
    public ThesisJuryDataModel(String nameSurname, String companyName, String role, String profession, String anotherProfession, String juryDate) {
