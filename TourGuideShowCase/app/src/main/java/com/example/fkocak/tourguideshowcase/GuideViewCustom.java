...
public class GuideViewCustom extends FrameLayout {

    static final String TAG = "GuideView";

    private static final int INDICATOR_HEIGHT              = 40; //// Çubuğun Boyu
    private static final int MESSAGE_VIEW_PADDING          = 5;  //Çubukla popup arasındaki mesafe
    private static final int SIZE_ANIMATION_DURATION       = 700; /// animasyon Hızı ne kadar azsa o kadar hızlı
    private static final int APPEARING_ANIMATION_DURATION  = 400; //// component geçişlerindeki hız ne kadar azsa o kadar hızlı
    private static final int CIRCLE_INDICATOR_SIZE         = 6; //// çubuğun ucundaki yuvarlak büyüklüğü
    private static final int LINE_INDICATOR_WIDTH_SIZE     = 3; //// Çubuğun kalınlığı
    private static final int STROKE_CIRCLE_INDICATOR_SIZE  = 3; //// çubuğun ucundaki yuvarlağın dış çizgi kalınlığı
    private static final int RADIUS_SIZE_TARGET_RECT       = 5; /// targetın radius değeri
    private static final int MARGIN_INDICATOR              = 15;

    private static final int BACKGROUND_COLOR              = 0x99000000; // Anlaşıldı
    private static final int CIRCLE_INNER_INDICATOR_COLOR  = 0xffcccccc; // Anlaşıldı
    private static final int CIRCLE_INDICATOR_COLOR        = Color.RED;
    private static final int LINE_INDICATOR_COLOR          = Color.YELLOW;
    ...
    private GuideMessageViewCustom mMessageView;


    private GuideViewCustom(Context context, View view) {
        super(context);
        ...
        mMessageView = new GuideMessageViewCustom(getContext());
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        if (target != null) {
            ...
            selfPaint.setColor(BACKGROUND_COLOR); //// Arka Backgroundu ayarlıyor. Hafif karanlık yapıyor
            ...
            paintCircleInner.setColor(CIRCLE_INNER_INDICATOR_COLOR); ///// Yuvarlağın içini değiştiriyor.
    ...
    public static class Builder {
        ...
        public GuideViewCustom build() {
            GuideViewCustom guideView = new GuideViewCustom(context, targetView);
