...
import com.example.fkocak.showcaseintroapptrial.R;

import java.util.List;

public abstract class AhoyOnboarderActivityCustom extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    private CircleIndicatorView circleIndicatorView;
    private ViewPager vpOnboarderPager;
    private AhoyOnboarderAdapterCustom ahoyOnboarderAdapter;
    ...
    private ShadowTransformerCustom mCardShadowTransformer;
    private Typeface typeface;
    private List<Integer> colorList;
    private boolean solidBackground = false;
    private List<AhoyOnboarderCardCustom> pages;
    ...
    public void setOnboardPages(List<AhoyOnboarderCardCustom> pages) {

        this.pages = pages;
        ahoyOnboarderAdapter = new AhoyOnboarderAdapterCustom(pages, getSupportFragmentManager(), dpToPixels(0, this), typeface);
        mCardShadowTransformer = new ShadowTransformerCustom(vpOnboarderPager, ahoyOnboarderAdapter);
    ...
    public void setGradientBackground() {
        ...
        FlowingGradientClassCustom grad = new FlowingGradientClassCustom();
