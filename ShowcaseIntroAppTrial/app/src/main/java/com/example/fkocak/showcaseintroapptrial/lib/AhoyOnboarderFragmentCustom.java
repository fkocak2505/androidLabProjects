...
public class AhoyOnboarderFragmentCustom extends Fragment {
    ...
    public AhoyOnboarderFragmentCustom() {
    }

    public static AhoyOnboarderFragmentCustom newInstance(AhoyOnboarderCardCustom card) {
        ...
        AhoyOnboarderFragmentCustom fragment = new AhoyOnboarderFragmentCustom();
