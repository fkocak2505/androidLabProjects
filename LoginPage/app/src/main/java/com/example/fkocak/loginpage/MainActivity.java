package com.example.fkocak.loginpage;
...
public class MainActivity extends AppCompatActivity {
    ...
    EditText email;
    EditText password;
    CardView animationCircle;
    View animationFirstArist;
    View animationSecondArist;
    View animationSquare;
    LinearLayout squareParent;
    TextView animationTV;
    ImageView twitterImageView;
    ImageView facebokImageView;
    ImageView instagramImageView;
    View singupFormContainer;
    View loginFormContainer;
    TextView loginTV;
    int backgrounColor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animationCircle = (CardView) findViewById(R.id.animation_circle);
        animationFirstArist = findViewById(R.id.animation_first_arist);
        animationSecondArist = findViewById(R.id.animation_second_arist);
        animationSquare = findViewById(R.id.animation_square);
        squareParent = (LinearLayout) animationSquare.getParent();
        animationTV = (TextView) findViewById(R.id.animation_tv);
        twitterImageView = (ImageView) findViewById(R.id.twitter_img);
        instagramImageView = (ImageView) findViewById(R.id.instagram_img);
        facebokImageView = (ImageView) findViewById(R.id.facebook_img);
        singupFormContainer = findViewById(R.id.signup_form_container);
        loginFormContainer = findViewById(R.id.login_form_container);
        loginTV = (TextView) findViewById(R.id.login_tv);
        backgrounColor = ContextCompat.getColor(this, R.color.colorAccent);
    ...
    public void showSingUp(View view) {
        ...
        a.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation arg0) {
                ...
                rootLayout.setBackgroundColor(ContextCompat.getColor(MainActivity.this, R.color.colorPrimary)); /// Üst Taraf
                ((View) animationSquare.getParent()).setBackgroundColor(ContextCompat.getColor(MainActivity.this, R.color.colorPrimary)); /// Alt taraf
