...
public class ToggleSwitchCustom extends BaseToggleSwitchCustom {

    private int mCheckedTogglePosition;

    public ToggleSwitchCustom(Context context) {
        this(context, null);
    }

    public ToggleSwitchCustom(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
