...
public abstract class BaseToggleSwitchCustom extends LinearLayout implements View.OnClickListener {
    ...
    public BaseToggleSwitchCustom(Context context) {
        this(context, null);
    }

    public BaseToggleSwitchCustom(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (attrs != null) {
            ...
            try {
                ...
                this.activeBgColor = attributes.getColor(R.styleable.ToggleSwitchOptions_activeBgColor, ContextCompat.getColor(context, BaseToggleSwitchCustom.Default.ACTIVE_BG_COLOR));
                this.activeTextColor = attributes.getColor(R.styleable.ToggleSwitchOptions_activeTextColor, ContextCompat.getColor(context, BaseToggleSwitchCustom.Default.ACTIVE_TEXT_COLOR));
                this.inactiveBgColor = attributes.getColor(R.styleable.ToggleSwitchOptions_inactiveBgColor, ContextCompat.getColor(context, BaseToggleSwitchCustom.Default.INACTIVE_BG_COLOR));
                this.inactiveTextColor = attributes.getColor(R.styleable.ToggleSwitchOptions_inactiveTextColor, ContextCompat.getColor(context, BaseToggleSwitchCustom.Default.INACTIVE_TEXT_COLOR));
                this.separatorColor = attributes.getColor(R.styleable.ToggleSwitchOptions_separatorColor, ContextCompat.getColor(context, BaseToggleSwitchCustom.Default.SEPARATOR_COLOR));
                this.textSize = attributes.getDimensionPixelSize(R.styleable.ToggleSwitchOptions_android_textSize, (int) dp2px(context, BaseToggleSwitchCustom.Default.TEXT_SIZE));
                this.toggleWidth = attributes.getDimension(R.styleable.ToggleSwitchOptions_toggleWidth, dp2px(getContext(), BaseToggleSwitchCustom.Default.TOGGLE_WIDTH));
                this.cornerRadius = attributes.getDimensionPixelSize(R.styleable.ToggleSwitchOptions_cornerRadius, (int) dp2px(context, BaseToggleSwitchCustom.Default.CORNER_RADIUS_DP));
    ...
    private void addToogleBtn(String text) {
        ...
        ToggleSwitchButtonCustom toggleSwitchButton = new ToggleSwitchButtonCustom(mContext);
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams((int) toggleWidth, LinearLayout.LayoutParams.WRAP_CONTENT);
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams((int) toggleWidth, LinearLayout.LayoutParams.MATCH_PARENT);
    ...
    private RoundRectShape buildRect(ToggleSwitchButtonCustom toggleSwitchButton) {
    ...
    protected int getToggleIndex(ToggleSwitchButtonCustom toggleSwitchButton) {
        return toggleSwitchesContainer.indexOfChild(toggleSwitchButton.getView());
    }

    protected ToggleSwitchButtonCustom getToggleSwitchButton(int position) {
        return new ToggleSwitchButtonCustom(toggleSwitchesContainer.getChildAt(position));
    }
    ...
    protected void setColors(ToggleSwitchButtonCustom toggleSwitchButton, int bgColor, int textColor) {
    ...
    public void setTogglePadding(int left, int top, int right, int bottom) {
        for (int i = 0; i < toggleSwitchesContainer.getChildCount(); i++) {
            ToggleSwitchButtonCustom toggleSwitchButton = new ToggleSwitchButtonCustom(toggleSwitchesContainer.getChildAt(i));
    ...
    private boolean isFirst(ToggleSwitchButtonCustom toggleSwitchButton) {
        return toggleSwitchesContainer.indexOfChild(toggleSwitchButton.getView()) == 0;
    }

    private boolean isLast(ToggleSwitchButtonCustom toggleSwitchButton) {
